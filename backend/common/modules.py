...
ROLE_MODULES = {
    ...
    'SUPER_ADMIN': [
        ...
        _mod('schools', 'School Management', '🏫', MANAGEMENT, '/erp/school/', 'School profile & campus'),
        _mod('years', 'Academic Year', '🗓️', MANAGEMENT, '/erp/academic-years/', 'Working days'),
        _mod('boards', 'Board Management', '📖', MANAGEMENT, '/erp/boards/', 'CBSE · Matriculation'),
        _mod('students', 'Student Management', '🧑‍🎓', MANAGEMENT, '/students/'),
        _mod('teachers', 'Teacher Management', '👨‍🏫', MANAGEMENT, '/academics/teacher/'),
        _mod('parents', 'Parent Management', '👨‍👩‍👧', MANAGEMENT, '/academics/parent/'),
        _mod('classes', 'Class / Section', '🏷️', ACADEMICS, '/academics/class/'),
        _mod('departments', 'Department Management', '🏢', ACADEMICS, '/academics/department/'),
        _mod('subjects', 'Subject Management', '📚', ACADEMICS, '/erp/subjects/', 'Teacher allocation'),
        _mod('houses', 'House Management', '🏰', ACADEMICS, '/erp/houses/', 'Houses & captains'),
        _mod('holidays', 'Holidays & Calendar', '🎉', ACADEMICS, '/erp/holidays/', 'School calendar'),
        _mod('attendance', 'Attendance Management', '📋', ACADEMICS, '/academics/attendance/'),
        _mod('homework', 'Homework / Assignment', '📝', ACADEMICS, '/erp/homework/', 'Create · grade'),
        _mod('exams', 'Examination & Results', '🗓️', ACADEMICS, '/academics/exams/'),
        _mod('lms', 'LMS Management', '💻', ACADEMICS, '/erp/homework/', 'Study material'),
        _mod('pet', 'PET / Sports', '🏃', ACADEMICS, '/erp/pet/', 'Physical education'),
        _mod('fees', 'Finance & Fees', '💰', ACADEMICS, '/erp/fees/', 'Fees · payments · ledger'),
        _mod('hostel', 'Hostel Management', '🏨', ACADEMICS, '/erp/hostel/', 'Rooms · allocation'),
        _mod('hrms', 'HRMS', '🧑‍💼', ACADEMICS, '/erp/hrms/', 'Employee master'),
        _mod('inventory', 'Inventory Management', '📦', ACADEMICS, '/erp/inventory/', 'Items · stock'),
        _mod('announcements', 'Communication', '📢', ACADEMICS, '/erp/announcements/', 'Announcements'),
        ...
        _mod('reports', 'Reports & Analytics', '📈', PORTFOLIOS, '/erp/reports/', 'Exports & KPIs'),
        _mod('audit', 'Audit Logs', '🧾', SYSTEM, '/erp/audit-logs/', 'Security trail'),
    ...
    'HR': [
        ...
        _mod('departments', 'Department Management', '🏢', ACADEMICS, '/academics/department/'),
        _mod('subjects', 'Subject Management', '📚', ACADEMICS, '/erp/subjects/', 'Teacher allocation'),
        _mod('attendance', 'Attendance', '📋', ACADEMICS, '/academics/attendance/'),
        _mod('homework', 'Homework / Assignment', '📝', ACADEMICS, '/erp/homework/', 'Create · grade'),
        _mod('exams', 'Examination & Results', '🗓️', ACADEMICS, '/academics/exams/'),
        _mod('leaves', 'Leave Management', '🍃', ACADEMICS, '/academics/leaves/'),
        _mod('pet', 'PET / Sports', '🏃', ACADEMICS, '/erp/pet/', 'Physical education'),
        _mod('fees', 'Finance & Fees', '💰', ACADEMICS, '/erp/fees/', 'Fees · payments · ledger'),
        _mod('hostel', 'Hostel Management', '🏨', ACADEMICS, '/erp/hostel/', 'Rooms · allocation'),
        _mod('hrms', 'HRMS', '🧑‍💼', ACADEMICS, '/erp/hrms/', 'Employee master'),
    ...
    'TEACHER': [
        ...
        _mod('attendance', 'Attendance', '📋', ACADEMICS, '/academics/attendance/'),
        _mod('leaves', 'My Leaves', '🍃', ACADEMICS, '/academics/leaves/'),
        _mod('homework', 'Homework', '📝', ACADEMICS, '/erp/homework/', 'Create · grade'),
        _mod('assignments', 'Assignments', '✅', ACADEMICS, '/erp/homework/'),
        _mod('lms', 'LMS / Study Materials', '💻', ACADEMICS, '/erp/homework/'),
        _mod('marks', 'Exams & Marks', '🔢', ACADEMICS, '/academics/exams/'),
        _mod('pet', 'PET / Sports', '🏃', ACADEMICS, '/erp/pet/', 'Physical education'),
        _mod('performance', 'Academic Performance', '📊', ACADEMICS, '/erp/reports/'),
...
'STUDENT': [
        ...
        _mod('academics', 'Academic Performance', '📚', ACADEMICS, '/erp/reports/', 'KPIs & trends'),
        _mod('marks', 'Subject Marks', '🔢', ACADEMICS, '/academics/exams/'),
        _mod('attendance', 'Attendance', '📋', ACADEMICS, '/academics/attendance/'),
        _mod('homework', 'Homework', '📝', ACADEMICS, '/erp/homework/', 'Submit · track'),
        _mod('assignments', 'Assignments', '✅', ACADEMICS, '/erp/homework/'),
        _mod('exams', 'Examination & Results', '🗓️', ACADEMICS, '/academics/exams/'),
        _mod('timetable', 'Timetable', '🕒', ACADEMICS, '', '', 'soon'),
        _mod('lms', 'LMS / Study Materials', '💻', ACADEMICS, '/erp/homework/'),
        _mod('pet', 'PET / Sports', '🏃', ACADEMICS, '/erp/pet/', 'Physical education'),
        _mod('fees', 'Fees & Payments', '💰', ACADEMICS, '/erp/fees/', 'My fee ledger'),
    ...
    'PARENT': [
        ...
        _mod('marks', 'Subject Marks', '🔢', ACADEMICS, '/academics/exams/'),
        _mod('exams', 'Examination Results', '🗓️', ACADEMICS, '/academics/exams/'),
        _mod('homework', 'Homework', '📝', ACADEMICS, '/erp/homework/', 'Child homework'),
        _mod('assignments', 'Assignment Status', '✅', ACADEMICS, '/erp/homework/'),
        _mod('pet', 'PET / Sports', '🏃', ACADEMICS, '/erp/pet/'),
        _mod('fees', 'Fees & Payments', '💰', ACADEMICS, '/erp/fees/'),
